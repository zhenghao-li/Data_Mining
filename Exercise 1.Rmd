...
In this figure, we look at the mean of arrival and departure delays separately, to see which months have the highest average delays . The graph reveals a positive relationship between arrival and departure delays. As departure delays increase or decrease in a given month, arrival delays increase/ decrease, respectively. As expected, if a traveler experiences a delay in his out of Austin flight, there is a great possibility that he or she will be faced with an arrival delay as well. 
